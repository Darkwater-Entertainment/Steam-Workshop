--[[
 - init.lua is the server file for the Fertilizer entity.
 - 
 - @author Kyle James
...
function ENT:SpawnFunction(ply, trace)
	...
	-- Local fields
	local ent = ents.Create("jc_fertilizer");
...
function ENT:Initialize()
	...
	self:SetModel("models/mosi/fallout4/props/junk/fertilizerbag.mdl");
