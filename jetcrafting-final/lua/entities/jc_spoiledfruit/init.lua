--[[
 - init.lua is the server file for the Spoiled Fruit entity.
 - 
 - @author Kyle James
...
function ENT:SpawnFunction(ply, trace)
	...
	-- Local fields
	local ent = ents.Create("jc_spoiledfruit");
...
function ENT:Initialize()
	...
	self:SetModel("models/mosi/fnv/props/food/crops/mutfruit01.mdl");
	...
	self:SetNWInt("amount", JC_SPOILED_FRUIT_AMOUNT);
	self:SetNWInt("maxAmount", JC_SPOILED_FRUIT_AMOUNT);
