--[[
 - init.lua is the server file for the Spoiled Vegetables entity.
 - 
 - @author Kyle James
...
function ENT:SpawnFunction(ply, trace)
	...
	-- Local fields
	local ent = ents.Create("jc_spoiledveggies");
...
function ENT:Initialize()
	...
	self:SetModel("models/mosi/fnv/props/food/crops/brocflower.mdl");
	...
	self:SetNWInt("amount", JC_SPOILED_VEGGIES_AMOUNT);
	self:SetNWInt("maxAmount", JC_SPOILED_VEGGIES_AMOUNT);
