--[[
 - init.lua is the server file for the Protein Extract entity.
 - 
 - @author Kyle James
...
function ENT:SpawnFunction(ply, trace)
	...
	-- Local fields
	local ent = ents.Create("jc_proteinextract");
...
function ENT:Initialize()
	...
	self:SetModel("models/mosi/fnv/props/food/bloodpaste.mdl");
	...
	self:SetNWInt("amount", JC_PROTEIN_EXTRACT_AMOUNT);
	self:SetNWInt("maxAmount", JC_PROTEIN_EXTRACT_AMOUNT);
