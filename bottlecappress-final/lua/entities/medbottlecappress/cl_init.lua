--[[
 - cl_init.lua is the client file for the Medium  Bottlecap Press entity.
 - 
 - @author Kyle James
...
function ENT:Draw()
	...
	if LocalPlayer():GetPos():Distance(self:GetPos()) < BP_UI_RANGE then
		...
		cam.Start3D2D(self:GetPos(), ang, 0.1);
			...
			draw.SimpleText("Bottle Cap Press v2", "MoneyFont", 0, -675, BP_TEXT_COLOR, TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER);
