--[[
  food_grilledmantis.lua
  File for the Grilled Mantis entity.
  @author Kyle James
  @version 31 May 2025
]]
...
ENT.Type = "anim"
ENT.Base = "fc_ent"
ENT.PrintName = "Grilled Mantis"
ENT.Category = "Fallout Consumables"
ENT.Spawnable = true

-- Consumable Configuration
ENT.ConsumableModel = "models/mosi/fnv/props/food/mantisclaw.mdl"
ENT.ConsumableModelColor = Color(255,255,255)
ENT.ConsumableSound = "npc/barnacle/barnacle_crunch2.wav"
ENT.ConsumableEffect = "mantisClaw"
ENT.ConsumableTime = 30
ENT.ConsumableDescription = [[A foreleg of a giant mantis that has been grilled to perfection]]
