...
ENT.ConsumableModel = "models/mosi/fnv/props/drink/water_clean.mdl"
ENT.ConsumableModelColor = Color(255, 255, 255)
ENT.ConsumableSound = "fc_fx/nukacola.mp3"
ENT.ConsumableEffect = "water"
ENT.ConsumableTime = 25
ENT.ConsumableDescription = [[The Mojave Wasteland has multiple natural sources
of pure, non-radioactive water, and as a result.]]
