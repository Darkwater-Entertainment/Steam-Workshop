...
ENT.ConsumableModel = "models/mosi/fnv/props/food/crops/maize.mdl"
ENT.ConsumableModelColor = Color(255,255,255)
ENT.ConsumableSound = "npc/barnacle/barnacle_crunch2.wav"
ENT.ConsumableEffect = "maize"
ENT.ConsumableTime = 9
ENT.ConsumableDescription = [[Grow on stalks all throughout the Mojave
Commonly grown by farmers.]]
