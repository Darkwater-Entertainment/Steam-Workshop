--[[
  food_iguana.lua
  File for the Iguana on a Stick entity.
  @author Kyle James
  @version 31 May 2025
]]
...
ENT.Type = "anim"
ENT.Base = "fc_ent"
ENT.PrintName = "Iguana on a Stick"
ENT.Category = "Fallout Consumables"
ENT.Spawnable = true

-- Consumable Configuration
ENT.ConsumableModel = "models/mosi/fnv/props/food/iguanaonastick.mdl"
ENT.ConsumableModelColor = Color(255,255,255)
ENT.ConsumableSound = "npc/barnacle/barnacle_crunch2.wav"
ENT.ConsumableEffect = "iguanaStick"
ENT.ConsumableTime = 12
ENT.ConsumableDescription = [[Some vegetables and a freshly flame-broiled iguana
delicately roasted in its own skin, makes this tasty treat so sought after.]]
