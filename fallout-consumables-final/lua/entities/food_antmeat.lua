...
ENT.Type = "anim"
ENT.Base = "fc_ent"
ENT.PrintName = "Ant Meat"
ENT.Category = "Fallout Consumables"
ENT.Spawnable = true

-- Consumable Configuration
ENT.ConsumableModel = "models/mosi/fnv/props/food/antmeat.mdl"
ENT.ConsumableModelColor = Color(255,255,255)
ENT.ConsumableSound = "npc/barnacle/barnacle_crunch2.wav"
ENT.ConsumableEffect = "antMeat"
ENT.ConsumableTime = 5
ENT.ConsumableDescription = [[Meat harvested from a giant ant.
Lightly seared.]]
