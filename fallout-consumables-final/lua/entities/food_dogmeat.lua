...
ENT.Type = "anim"
ENT.Base = "fc_ent"
ENT.PrintName = "Dog Meat"
ENT.Category = "Fallout Consumables"
ENT.Spawnable = true

-- Consumable Configuration
ENT.ConsumableModel = "models/mosi/fnv/props/food/dogmeat.mdl"
ENT.ConsumableModelColor = Color(255,255,255)
ENT.ConsumableSound = "npc/barnacle/barnacle_crunch2.wav"
ENT.ConsumableEffect = "dogMeat"
ENT.ConsumableTime = 8
ENT.ConsumableDescription = [[Meat from a wild (or domestic) dog.
A little chewy...]]
