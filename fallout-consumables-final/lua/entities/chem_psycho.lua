...
ENT.ConsumableModel = "models/mosi/fnv/props/health/chems/psycho.mdl"
ENT.ConsumableModelColor = Color(255, 255, 255)
ENT.ConsumableSound = "fc_fx/stimpak.mp3"
ENT.ConsumableEffect = "psycho"
ENT.ConsumableTime = 240
ENT.ConsumableDescription = [[A military-grade psychosis-inducing amphetamine.]]
...
if SERVER then
	...
	function ENT:Use(activator, caller)
		...
		if activator:HasConsumableEffect("psycho") then
			local remaining = activator.Effects["psycho"] - CurTime()
			if remaining > (self.ConsumableTime - rand) then
				activator:AddConsumableEffect("overdose", 10)
			end
			activator:AddConsumableEffect("psycho", 240)
		end
