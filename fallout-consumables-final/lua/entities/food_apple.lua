--[[
  food_apple.lua
  File for the Fresh Apple entity.
  @author Kyle James
  @version 31 May 2025
]]
...
ENT.Type = "anim"
ENT.Base = "fc_ent"
ENT.PrintName = "Fresh Apple"
ENT.Category = "Fallout Consumables"
ENT.Spawnable = true

-- Consumable Configuration
ENT.ConsumableModel = "models/mosi/fnv/props/food/crops/apple02.mdl"
ENT.ConsumableModelColor = Color(255,255,255)
ENT.ConsumableSound = "npc/barnacle/barnacle_crunch2.wav"
ENT.ConsumableEffect = "freshApple"
ENT.ConsumableTime = 7
ENT.ConsumableDescription = [[An oddly fresh apple
