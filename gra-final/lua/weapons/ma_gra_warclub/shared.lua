...
SWEP.Purpose = "It is made of a hardwood native to the Zion Valley that has been sculpted into a 2-foot long club. The war club is the signature weapon of the Dead Horses tribe, hence the striking end of the weapon being shaped like a horse's head."
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 15
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/warclub.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["hammer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/warclub.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.239, 0.737, 8.451), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1.8, 1.8, 1.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
