...
SWEP.Slot = 0
SWEP.PrintName = "Nephi's Golf Driver"
...
SWEP.Purpose = "Nephi's golf driver is a unique golf club utilized as a two-handed weapon."
...
SWEP.WepName="ma_gra_nephisgolfdriver"
...
SWEP.DmgMin2 = 4
SWEP.DmgMax2 = 19
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/gclub.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/gclub.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1, 0.75, 32), angle = Angle(-2.395, 105.603, 175.055), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/gclub.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3, 1, 30), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}