...
SWEP.Purpose = "Knock-Knock is a cleaner, more powerful version of the fire axe, with a matte black handle and a polished steel head with a longer fluke."
...
SWEP.WepName="ma_gra_knockknock"
...
SWEP.DmgMin2 = 5
SWEP.DmgMax2 = 16
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/fireaxeunique.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/fireaxeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.5, 1.5, 28), angle = Angle(0, 90, 177.274), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/fireaxeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.301, 0.552, 23.834), angle = Angle(0, 80.23, 167.654), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}