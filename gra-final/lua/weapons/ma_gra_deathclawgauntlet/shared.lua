...
SWEP.Purpose = "The Deathclaw Gauntlet is the hand of a Deathclaw strapped to your arm, giving the user death's claws."
...
SWEP.WepName="ma_gra_deathclawgauntlet"
...
SWEP.VElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/deathclawgauntlet.mdl", bone = "ValveBiped.Bip01_R_Forearm", rel = "", pos = Vector(15.69, 0.214, 0.58), angle = Angle(-94.746, -90, 0), size = Vector(0.713, 0.713, 0.713), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/deathclawgauntlet.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.835, 0.417, -0.099), angle = Angle(0, 93.171, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
