...
SWEP.Purpose = "This knife belonged to Chance, one of the Great Khans and a prominent character in the graphic novel All Roads. The blade is still stained by the blood of the Fiends it last killed at the tribal village."
...
SWEP.WepName="ma_gra_chancesknife"
...
SWEP.DmgMin2 = 3
SWEP.DmgMax2 = 10
SWEP.ThrowModel = "models/Halokiller38/fallout/weapons/Melee/chancesknife.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["knife"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/chancesknife.mdl", bone = "Weapon", rel = "", pos = Vector(7, -1.02, -0.75), angle = Angle(92.831, 90, -97.359), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["kabar"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/chancesknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.301, 0.912, 2.563), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
