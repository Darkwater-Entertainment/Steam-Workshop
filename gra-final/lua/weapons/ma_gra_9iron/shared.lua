...
SWEP.Purpose = "This old 9 iron is bent and battered after many years of exposure to the elements."
...
SWEP.DmgMin2 = 4
SWEP.DmgMax2 = 19
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/9iron.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/9iron.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.349, 0.949, 20.93), angle = Angle(-2.395, 105.603, 175.055), size = Vector(1.292, 1.292, 1.292), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/9iron.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.326, 1.442, 10.981), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}