...
SWEP.Purpose = "A primitive but effective weapon used by Caesar's Legion to take out opponents from a distance without having to rely on bullets."
...
SWEP.WepName="ma_gra_throwingspear"

--Primary Attack Charge Values
SWEP.Explanation = "A primitive but effective weapon used by Caesar's Legion to take out opponents from a distance without having to rely on bullets."
SWEP.EntName = "magrathrowingspear"
SWEP.Velocity = 1200
...
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/spear.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.ViewModelBoneMods = {
	...
	["ValveBiped.Bip01_Spine4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -10), angle = Angle(0, 0, 0) }
}
...
SWEP.VElements = {
	["Smokebomb"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/spear.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(2, -5, 5), angle = Angle(0, 180, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["Smokebomb1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/spear.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, -3), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}