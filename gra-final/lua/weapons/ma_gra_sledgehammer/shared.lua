...
SWEP.Purpose = "Sledgehammers are primitive weapons, used as tools before the Great War."
...
SWEP.WepName="ma_gra_sledgehammer"
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 28
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/sledgehammer.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.Hit1Sound="physics/metal/metal_barrel_impact_hard6.wav"
SWEP.Hit2Sound="physics/metal/metal_barrel_impact_hard6.wav"
SWEP.Hit3Sound="physics/metal/metal_barrel_impact_hard6.wav"

SWEP.Impact1Sound="physics/metal/metal_barrel_impact_hard6.wav"
SWEP.Impact2Sound="physics/metal/metal_barrel_impact_hard6.wav"
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/sledgehammer.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.619, 1.65, -20.676), angle = Angle(-1.17, 102.857, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/sledgehammer.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.236, 1, 15.597), angle = Angle(-180, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}