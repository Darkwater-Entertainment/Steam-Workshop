...
SWEP.Purpose = "This 2x4 has several nails driven through it, with a whittled shaft to ensure a better grip."
...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 18
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/nailboard.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["harpoon"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/nailboard.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.408, -23.118, -3.492), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1.172, 1.172, 1.172), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["harpoon1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/nailboard.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.97, -20.001, -3.493), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
