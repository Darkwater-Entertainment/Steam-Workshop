...
SWEP.Purpose = "Brass knuckles, or knuckledusters, take the form of four linked metal rings in a shallow convex formation with a bumper attached to the concave face."
...
SWEP.WepName="ma_gra_brassknuckles"
...
SWEP.VElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/brassknuckles.mdl", bone = "ValveBiped.Bip01_R_Forearm", rel = "", pos = Vector(15.5, 0.95, 1.6), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/brassknuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.835, 0.417, -0.099), angle = Angle(0, 93.171, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
