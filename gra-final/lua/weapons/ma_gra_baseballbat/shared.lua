...
SWEP.Purpose = "Baseball bats were once used in the sport of baseball, considered America's number-one pastime during the pre-War era. 200 years later, they have been re-purposed as crude but effective melee weapons."
...
SWEP.WepName="ma_gra_baseballbat"
...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 18
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/baseballbat.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["harpoon"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/baseballbat.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, -2.5), angle = Angle(0, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["harpoon1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/baseballbat.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.75, 1, 4.5), angle = Angle(180, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
