...
SWEP.Purpose = "The proton axe resembles a futuristic war-axe with a glowing blue blade of electrical energy at its head."
...
SWEP.DmgMin2 = 40
SWEP.DmgMax2 = 55.6
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/protonaxe.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/protonaxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.75, -2.5, 10), angle = Angle(0, 90, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/protonaxe.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, -2.5, 5), angle = Angle(0, 80.23, 167.654), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}