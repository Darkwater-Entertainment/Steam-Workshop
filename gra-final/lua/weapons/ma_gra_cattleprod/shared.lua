...
SWEP.Purpose = "Normally used for herding stubborn cattle, it has been re-purposed as a non-lethal weapon against humans. In addition to the taser-like prongs at the tip normally found on cattle prods, it has been outfitted with a thick, electrified metal coil around the striking end, hooked up to a pair of batteries taped down near the handle."
...
SWEP.WepName="ma_gra_cattleprod"
...
SWEP.DmgMin2 = 3
SWEP.DmgMax2 = 12
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/cattleprod.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["stam"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/cattleprod.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.569, 1.485, 15.173), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1.299, 1.299, 1.299), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["knife"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/cattleprod.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.666, 2.206, 11.203), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}