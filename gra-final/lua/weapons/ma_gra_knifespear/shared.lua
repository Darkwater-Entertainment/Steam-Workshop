...
SWEP.Purpose = "The knife spear is a two-handed Melee weapon often carried by the ghost people of the Sierra Madre."
...
SWEP.WepName="ma_gra_knifespear"
...
SWEP.DmgMin2 = 42
SWEP.DmgMax2 = 58.4
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/knifespear.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["harpoon"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/knifespear.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, 6), angle = Angle(0, 270, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["harpoon1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/knifespear.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, -10), angle = Angle(180, 225, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
