...
SWEP.Purpose = "The Shishkebab is a flaming melee weapon which sets the target on fire upon impact."
...
SWEP.WepName="ma_gra_shishkebab"
...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 18
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/shishkebab.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/shishkebab.mdl", bone = "RW_Weapon", rel = "", pos = Vector(-0.5, 13, 15), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/shishkebab.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(23, 1, -6), angle = Angle(180, 270, -35), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}