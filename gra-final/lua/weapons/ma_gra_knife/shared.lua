...
SWEP.Purpose = "A simple chef's knife with low melee damage."
...
SWEP.DmgMin2 = 3
SWEP.DmgMax2 = 10
SWEP.ThrowModel = "models/Halokiller38/fallout/weapons/Melee/kitchenknife.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["knife"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/kitchenknife.mdl", bone = "Weapon", rel = "", pos = Vector(4.5, -1.02, -0.75), angle = Angle(92.831, 90, -97.359), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["kabar"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/kitchenknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.801, 0.912, 0.563), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
