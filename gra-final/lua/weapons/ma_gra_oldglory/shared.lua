...
SWEP.Purpose = "It is a maple flag pole capped with a golden eagle."
...
SWEP.DmgMin2 = 4
SWEP.DmgMax2 = 19
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/eagleflagpoll.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/eagleflagpoll.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, -2.5, 45), angle = Angle(0, 0, 175.055), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/eagleflagpoll.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.5, -5, 30), angle = Angle(0, 0, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}