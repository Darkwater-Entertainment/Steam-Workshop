...
SWEP.Purpose = "The tomahawk is a thrown weapon. It is a make-shift weapon, and is made out of two railway spikes secured to a pipe with electrical cable and a bungee cord with feathers, paint, and beads for decoration."
...
SWEP.WepName="ma_gra_tomahawk"

--Primary Attack Charge Values
SWEP.Explanation = "The tomahawk is a thrown weapon. It is a make-shift weapon, and is made out of two railway spikes secured to a pipe with electrical cable and a bungee cord with feathers, paint, and beads for decoration."
SWEP.EntName = "magratomahawk"
SWEP.Velocity = 1200
...
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/tomahawk.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["Smokebomb"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/tomahawk.mdl", bone = "v_weapon.Flashbang_Parent", rel = "", pos = Vector(-0, 1.557, -0.32), angle = Angle(-180, 180, 108.7), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["Smokebomb1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/tomahawk.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 2, 0), angle = Angle(180, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}