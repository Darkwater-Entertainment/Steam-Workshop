...
SWEP.Slot = 0
SWEP.PrintName = "Samurai's Sword"
...
SWEP.Purpose = "A katana is a type of Japanese sword with a blade length greater than 23.6-28.7 inches (60-73 centimeters) and characterized by its distinctive appearance: a curved, slender, single-edged blade, circular or squared guard, and long grip that can accommodate two hands."
...
SWEP.WepName="ma_gra_samuraissword"
...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 22
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/samuraisword.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/samuraisword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.45, -0.75, -4), angle = Angle(0, 0, 4.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/samuraisword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, 5), angle = Angle(180, 270, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}