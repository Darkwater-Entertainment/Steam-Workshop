...
SWEP.Slot = 0
SWEP.PrintName = "The Humble Cudgel"
...
SWEP.Purpose = "The Humble Cudgel is a unique version of the lead pipe."
...
SWEP.WepName="ma_gra_thehumblecudgel"
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 15
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/leadpipeunique.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["hammer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/leadpipeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.75, 1.25, 7), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["knife"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/leadpipeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(1.439, 1.289, 5.748), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}