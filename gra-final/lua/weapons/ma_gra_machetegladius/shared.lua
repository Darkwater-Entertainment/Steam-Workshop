...
SWEP.WepName="ma_gra_machetegladius"
...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 18
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/machetegladius.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/machetegladius.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, 0, -6), angle = Angle(0, 180, 4.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/machetegladius.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.5, 2, 5.832), angle = Angle(10, 45.183, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}