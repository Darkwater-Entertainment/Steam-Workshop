...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 22
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/katana.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/katana.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.45, -0.75, -4), angle = Angle(0, 0, 4.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/katana.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1, 5), angle = Angle(180, 270, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}