...
SWEP.Purpose = "The cleaver was designed to chop hunks of meat for use in butcher's shops, but has since been repurposed as a melee weapon."
...
SWEP.DmgMin2 = 4
SWEP.DmgMax2 = 12
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/cleaver.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["axe"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/cleaver.mdl", bone = "smdimport", rel = "", pos = Vector(0, 0, -2), angle = Angle(0, 180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["axe"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/cleaver.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1, 1), angle = Angle(180, -90, 0), size = Vector(1.08, 1.08, 1.08), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}