...
SWEP.Purpose = "A rusty old tire iron, normally used for loosening nuts from car tires. The tire iron has a high damage for a low-level weapon."
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 15
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/tireiron.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.Hit1Sound="physics/metal/metal_canister_impact_hard1.wav"
SWEP.Hit2Sound="physics/metal/metal_canister_impact_hard2.wav"
SWEP.Hit3Sound="physics/metal/metal_canister_impact_hard3.wav"
...
SWEP.VElements = {
	["hammer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/tireiron.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.749, 0.981, 20.925), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1.8, 1.8, 1.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["knife"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/tireiron.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-0.439, 1.289, 10.748), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}