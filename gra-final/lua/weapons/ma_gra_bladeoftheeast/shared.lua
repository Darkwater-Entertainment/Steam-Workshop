...
SWEP.Slot = 0
SWEP.PrintName = "Blade of the East"
...
SWEP.Purpose = "The bumper sword consists of a chrome car bumper that has been pounded out and sharpened into a thick, heavy blade. The license plate is still attached, and an exhaust pipe strapped to the unsharpened end serves as a makeshift handle."
...
SWEP.WepName="ma_gra_bladeoftheeast"
...
SWEP.DmgMin2 = 10
SWEP.DmgMax2 = 35
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/bumpersword.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["mattpipe"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/bumpersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.104, 0.55, 20.556), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["mattpipe1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/bumpersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.645, 1.2, 17.055), angle = Angle(0, 270, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}