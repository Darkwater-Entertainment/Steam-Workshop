...
SWEP.Purpose = "This crude weapon is a piece of concrete with three pieces of rebar sticking out of it."
...
SWEP.Hit1Sound="physics/concrete/concrete_break2.wav"
SWEP.Hit2Sound="physics/concrete/concrete_break3.wav"
SWEP.Hit3Sound="physics/concrete/concrete_break2.wav"

SWEP.Impact1Sound="physics/concrete/concrete_break2.wav"
SWEP.Impact2Sound="physics/concrete/concrete_break3.wav"
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/rebar.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, -0.5, -15), angle = Angle(0, 0, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/rebar.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.236, 1, 15.597), angle = Angle(-180, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}