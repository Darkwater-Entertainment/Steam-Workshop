...
SWEP.Purpose = "These have the same design as the brass knuckles, but are made from a darker metal and have spikes attached to each knuckle, enabling the knuckles to puncture and slash open the skin of an opponent."
...
SWEP.WepName="ma_gra_spikedknuckles"
...
SWEP.VElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/spikedknuckles.mdl", bone = "ValveBiped.Bip01_R_Forearm", rel = "", pos = Vector(14.5, 0.5, 1.5), angle = Angle(270, 0, 90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["powerfist"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/spikedknuckles.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 0.417, 0), angle = Angle(0, 93.171, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
