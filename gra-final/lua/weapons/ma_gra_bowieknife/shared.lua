...
SWEP.Purpose = "The Bowie knife has a large clip-point blade and a riveted brown handle."
...
SWEP.WepName="ma_gra_bowieknife"
...
SWEP.DmgMin2 = 3
SWEP.DmgMax2 = 10
SWEP.ThrowModel = "models/Halokiller38/fallout/weapons/Melee/bowieknife.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["knife"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/bowieknife.mdl", bone = "Weapon", rel = "", pos = Vector(6.5, -0.02, -0.75), angle = Angle(92.831, 90, -97.359), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["kabar"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/bowieknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.801, 1.24, 2.197), angle = Angle(180, -90.002, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
