...
SWEP.Purpose = "A plain wooden rolling pin used in baking to flatten the dough, with a couple of thin streaks of blood down one side."
...
SWEP.WepName="ma_gra_rollingpin"
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 15
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/rollingpin.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["hammer"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/rollingpin.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.5, 1.11, 12.034), angle = Angle(-2.395, 87.315, 177.376), size = Vector(1, 1, 1.09), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
