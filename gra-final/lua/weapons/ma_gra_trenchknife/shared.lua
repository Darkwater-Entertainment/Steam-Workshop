...
SWEP.Purpose = "There is no functional difference between the regular combat knife and the trench knife, only the visual touch of a spiked knuckle guard. It can be repaired using standard combat knives."
...
SWEP.WepName="ma_gra_trenchknife"
...
SWEP.DmgMin2 = 3
SWEP.DmgMax2 = 10
SWEP.ThrowModel = "models/Halokiller38/fallout/weapons/Melee/trenchknife.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["knife"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/trenchknife.mdl", bone = "Weapon", rel = "", pos = Vector(5.5, -1.5, -0.75), angle = Angle(92.831, 90, -97.359), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["kabar"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/trenchknife.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.801, 0.912, 1.563), angle = Angle(180, -90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
