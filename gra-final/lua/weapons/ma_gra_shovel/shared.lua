...
SWEP.Purpose = "A wood handled shovel to be used against weaker enemies."
...
SWEP.DmgMin2 = 4
SWEP.DmgMax2 = 19
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/shovel.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/shovel.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-1.349, 0.949, 37.93), angle = Angle(-2.395, 105.603, 175.055), size = Vector(1.292, 1.292, 1.292), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel1"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/shovel.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-2.826, 1.442, 27.981), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}