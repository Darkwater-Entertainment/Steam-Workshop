...
SWEP.Purpose = "The straight razor is an old-fashioned shaving razor with a polished wooden handle. Though its blade is short, it's lightweight and can deliver several slashing hits in rapid succession."
...
SWEP.WepName="ma_gra_straightrazor"
...
SWEP.DmgMin2 = 2
SWEP.DmgMax2 = 6
SWEP.ThrowModel = "models/Halokiller38/fallout/weapons/Melee/straightrazor.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["kabar"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/straightrazor.mdl", bone = "v_weapon.Knife_Handle", rel = "", pos = Vector(-0.076, -0.317, -9.256), angle = Angle(0, -180, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["kabar"] = { type = "Model", model = "models/Halokiller38/fallout/weapons/Melee/straightrazor.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.519, 0.713, 8.001), angle = Angle(0, 90, 167.442), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
