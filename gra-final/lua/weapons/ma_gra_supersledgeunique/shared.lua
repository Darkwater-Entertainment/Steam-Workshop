...
SWEP.WepName="ma_gra_supersledgeunique"
...
SWEP.DmgMin2 = 8
SWEP.DmgMax2 = 28
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/supersledgeunique.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/supersledgeunique.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0.619, -0.219, -20.676), angle = Angle(-1.17, 102.857, 1.169), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["shovel"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/supersledgeunique.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.236, 1, 15.597), angle = Angle(-180, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}