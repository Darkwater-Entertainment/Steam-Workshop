...
SWEP.Slot = 0
SWEP.PrintName = "Chinese Officer's Sword"
...
SWEP.Purpose = "A People's Liberation Army officer's dress sword, these weapons are remnants from the United States' war with China, an event that triggered the Great War."
...
SWEP.WepName="ma_gra_chineseofficersword"
...
SWEP.DmgMin2 = 6
SWEP.DmgMax2 = 18
SWEP.ThrowModel = "models/halokiller38/fallout/weapons/melee/chineseofficersword.mdl"
SWEP.ThrowMaterial = ""
SWEP.ThrowScale = 1
...
SWEP.VElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/chineseofficersword.mdl", bone = "RW_Weapon", rel = "", pos = Vector(0, -0.2, -2), angle = Angle(0, 0.675, 4.831), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
SWEP.WElements = {
	["katana"] = { type = "Model", model = "models/halokiller38/fallout/weapons/melee/chineseofficersword.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2, 1, 0.832), angle = Angle(180, 90, 35), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}