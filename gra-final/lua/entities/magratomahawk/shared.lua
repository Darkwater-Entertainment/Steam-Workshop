...
ENT.Purpose			= "The tomahawk is a thrown weapon. It is a make-shift weapon, and is made out of two railway spikes secured to a pipe with electrical cable and a bungee cord with feathers, paint, and beads for decoration."
...
function ENT:Initialize()
	...
	self.Entity:SetModel("models/halokiller38/fallout/weapons/melee/tomahawk.mdl")
